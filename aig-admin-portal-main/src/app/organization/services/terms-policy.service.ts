...
export class TermsPolicyService {
  ...
  getContent(type: string, userType: string) {
    ...
    return this.http.get(ApiRoutes.ORGANIZATION_GET_TERMS_AND_POLICY, { params });
  }
  ...
  addContent(userType: string, content: string, type: string) {
    ...
    return this.http.post(ApiRoutes.ORGANIZATION_ADD_TERMS_AND_POLICY, null, { params });
  }
  ...
  updateContent(userType: string, content: string, type: string) {
    ...
    return this.http.put(ApiRoutes.ORGANIZATION_UPDATE_TERMS_AND_POLICY, null, { params });
  }
}
